...
Be sure to check 'My Application' to ensure you've applied to BoilerMake IX.  This email only confirms that you've created a BoilerMake.org account – the application is separate.
...
func (h *Handler) getDashboard() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		a.Decision = models.DecisionAccepted
